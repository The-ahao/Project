...
{  
    ...
    //应用旋转
    //应用位置
    [SerializeField, Header("相机观察目标")] private Transform camLookTarget;
    [SerializeField, Header("相机到目标距离")] private float camToTargetDistance;
    ...
    [SerializeField, Header("镜头移动速度(鼠标)")] private float camLerpSpeedOnMouce;
    [SerializeField, Header("镜头未移动速度")] private float camLerpSpeedOnNormal;
    [SerializeField] private float currentCamLerpSpeed;
    [SerializeField, Header("垂直角度限制")] private Vector2 camClampRange;
